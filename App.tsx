...
const App: React.FC = () => {
  ...
  const [currentStage, setCurrentStage] = useState<Stage>('OPERATOR');
  ...
  const isReady = !!(
    ...
    hasRouteData &&
    hasBolEvidence &&
    (eventType !== 'DELIVERY' || bolNum.trim())
  );
              ...
              <select
                ...
                onChange={(e) => {
                  if (e.target.value === 'MANUAL') {
                    ...
                    const nextDriver = e.target.value.toUpperCase();
                    ...
                    setShowFreightPrompt(false);
                    setShowVerification(false);
                    setCurrentStage(nextDriver ? 'EVENT' : 'OPERATOR');
                  }
                }}
              >
            ...
            {eventType === 'DELIVERY' && (
              <div className="mb-6">
                <input
                  ...
                  value={bolNum}
                  onChange={(e) => setBolNum(e.target.value.toUpperCase())}
                />
              </div>
            )}
          ...
          <div className="max-w-xl mx-auto p-10 pb-56 space-y-12">
            ...
            <div className="grid grid-cols-1 gap-4">
              {[
                ...
                ...(eventType === 'DELIVERY'
                  ? [{ l: 'BOL NUMBER', v: bolNum || 'N/A', id: 'bolNum' }]
                  : []),
