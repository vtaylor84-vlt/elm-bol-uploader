...
const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxT_Zl6T-iP7NemVqxJ3rFILPMtsEofJ-lyX1ghOeKqeuyJecTjAElheGazedvVpkXx/exec';
...
const App: React.FC = () => {
  ...
  // --- [FIX] INTEGRATED ROSTER FETCH WITH ACTION PARAM ---
  useEffect(() => {
  ...
  if (isLocked) return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 text-white font-sans overflow-hidden">
      <div className="absolute top-12 flex flex-col items-center opacity-40">
        ...
        <div className="text-[10px] font-black tracking-[0.5em] mt-4">QLMCONNECT v33.7</div>
      </div>
      <button onClick={() => {
  ...
  return (
    <div className={`min-h-screen transition-all duration-700 ${solarMode ? 'bg-zinc-100 text-black' : 'bg-[#020202] text-zinc-100'} pb-32`}>
      ...
      {/* FREIGHT PROMPT & TACTICAL REVIEW (RETAINED FROM v33.3) */}
      {showFreightPrompt && (
